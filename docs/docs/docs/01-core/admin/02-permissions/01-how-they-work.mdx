...
The creation and edition of permissions is done through the [edit page](http://192.168.0.138:1337/admin/settings/roles/2) of a role by checking or unchecking checkboxes.
...
The permissions are modified in the admin panel (on the [edit page](http://192.168.0.138:1337/admin/settings/roles/2) of a role) and stored in the database with the following information:
