...
describe('ConfigurationProvider', () => {
  ...
  it('should not crash', async () => {
    ...
    await screen.findByText('http://192.168.0.138:1337/uploads/michka.svg');
  });
  ...
  it.skip('should use the default logo and update customMenuLogo with setCustomMenuLogo', async () => {
    ...
    expect(screen.getByText('http://192.168.0.138:1337/uploads/michka.svg')).toBeInTheDocument();
  });
});
